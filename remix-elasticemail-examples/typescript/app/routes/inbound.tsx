...
export const meta: MetaFunction = () => [{ title: "Inbound - Elastic Email Examples" }];

const handlerCode = `// app/routes/api.inbound.ts
  ...
  return (
    <main>
      <PageHeader
        ...
        sourcePath="app/routes/api.inbound.ts"
      />
      ...
      <div className="card">
        ...
        <ol>
          ...
          <li>
            Expose the dev server (for example <code>ngrok http 5173</code>) and set <code>PUBLIC_URL</code> to the
            HTTPS URL.
          </li>
          <li>
