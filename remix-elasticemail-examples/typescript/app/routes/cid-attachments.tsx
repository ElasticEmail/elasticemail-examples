...
export const meta: MetaFunction = () => [{ title: "CID Attachments - Elastic Email Examples" }];
...
export default function CidAttachments() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    fetcher.submit({ to: String(form.get("to")) }, { method: "post", action: "/api/send-cid", encType: "application/json" });
  };
  ...
  return (
    <main>
      <PageHeader
        ...
        sourcePath="app/routes/api.send-cid.ts"
      />
