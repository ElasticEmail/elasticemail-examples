...
const AttachmentsPage = () => {
  ...
  return (
    <main>
      ...
      <PageHeader title="Email with Attachments" description="Attach a base64-encoded file to a transactional email." sourcePath="api/src/functions/sendAttachment.ts" />
