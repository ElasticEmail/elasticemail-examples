...
const StatisticsPage = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setResult(null);
    try {
      const res = await fetch(`/.redwood/functions/statistics?${new URLSearchParams({ days: String(form.get("days") ?? "") })}`);
  ...
  return (
    <main>
      ...
      <PageHeader title="Statistics" description="Account-wide sending statistics for a date range." sourcePath="api/src/functions/statistics.ts" />
