...
const TemplatesPage = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    setResult(null);
    try {
      const res = await fetch("/.redwood/functions/sendTemplate", {
        method: "POST",
  ...
  return (
    <main>
      <Metadata title="Templates" description="Send a stored Elastic Email template with merge fields. The template is created on first use." />

      <PageHeader title="Email Templates" description="Send a stored Elastic Email template with merge fields. The template is created on first use." sourcePath="api/src/functions/sendTemplate.ts" />
