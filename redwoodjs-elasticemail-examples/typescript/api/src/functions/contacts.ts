// GET  /.redwood/functions/contacts            -> contacts on ELASTICEMAIL_LIST_NAME
// POST /.redwood/functions/contacts            -> body { email, firstName?, lastName? }
import type { APIGatewayEvent, Context } from "aws-lambda";
import { apiError, contactsApi, json, listName, listsApi, readJson } from "src/lib/elasticemail";
