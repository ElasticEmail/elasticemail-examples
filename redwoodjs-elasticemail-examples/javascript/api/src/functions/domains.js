// GET  /.redwood/functions/domains             -> all domains on the account
// POST /.redwood/functions/domains             -> body { domain? } (defaults to SENDING_DOMAIN)

import { apiError, domainsApi, json, readJson, sendingDomain } from "src/lib/elasticemail";
