  ...
  return (
    <main>
      ...
      <PageHeader
        title="Double Opt-In"
        description="Subscribe a contact only after they confirm through an email link."
        sourcePath="api/src/functions/doubleOptinSubscribe.ts"
      />
      ...
      <div className="card">
        ...
        <ol>
          ...
          <li>
            <code>/.redwood/functions/doubleOptinConfirm</code> validates the token and calls{" "}
            <code>listsByNameContactsPost</code>
          </li>
          <li>
            Alternative: point an Elastic Email webhook for Clicked events at{" "}
            <code>/.redwood/functions/doubleOptinWebhook</code>
          </li>
        </ol>
      </div>
