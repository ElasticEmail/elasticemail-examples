  ...
  return (
    <main>
      ...
      <PageHeader
        ...
        description="Receive parsed emails through an Elastic Email inbound route and forward them."
        sourcePath="api/src/functions/inbound.ts"
      />
      ...
      <div className="card">
        ...
        <ol>
          ...
          <li>
            Expose the dev server (for example <code>ngrok http 8910</code>) and set <code>PUBLIC_URL</code> to the
            HTTPS URL.
          </li>
          <li>
            Create an inbound route with action <code>NotifyViaHttp</code> and address{" "}
            <code>PUBLIC_URL/.redwood/functions/inbound?token=ELASTICEMAIL_WEBHOOK_TOKEN</code>, either in the dashboard
