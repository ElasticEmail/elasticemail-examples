...
// readBody parses the form-encoded body into an object.
import { defineEventHandler, getQuery } from "h3";
import { apiError, contactEmail, emailsApi, fail, from, readEvent, sanitize, tokenOk } from "../utils/elasticemail";
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    return { received: true, attachments: attachments.length, forwardedMessageId: data.MessageID };
  } catch (err) {
