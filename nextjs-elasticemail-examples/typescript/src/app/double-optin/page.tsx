  ...
  return (
    <main>
      <PageHeader
        ...
        sourcePath="src/app/double-optin/subscribe/route.ts"
      />
      ...
      <h2>Subscribe</h2>
      <CodeBlock code={subscribeCode} title="src/app/double-optin/subscribe/route.ts" />

      <h2>Confirm</h2>
      <CodeBlock code={confirmCode} title="src/app/double-optin/confirm/route.ts" />
    </main>
  );
}
