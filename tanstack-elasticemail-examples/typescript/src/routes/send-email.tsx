...
export const Route = createFileRoute("/send-email")({
  ...
  head: () => ({ meta: [{ title: "Basic Send - Elastic Email Examples" }] }),
});
...
function SendEmailPage() {
  ...
  return (
    <main>
      <PageHeader title="Basic Send Email" description="Send a simple HTML email through POST /emails/transactional." sourcePath="src/routes/api/send.ts" />
      ...
      <form onSubmit={handleSubmit} className="form">
        ...
        <div className="field">
          ...
          <textarea id="message" name="message" required defaultValue="This is a test email sent from the Elastic Email examples app." rows={4} />
        </div>
