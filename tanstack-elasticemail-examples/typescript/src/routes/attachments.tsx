...
function AttachmentsPage() {
  ...
  return (
    <main>
      <PageHeader title="Email with Attachments" description="Attach a base64-encoded file to a transactional email." sourcePath="src/routes/api/send-attachment.ts" />
