...
import { apiError, contactsApi, emailsApi, from, hmac, json, publicUrl, readJson } from "../../../lib/elasticemail";

export const Route = createFileRoute("/api/double-optin/subscribe")({
  server: {
    handlers: {
      POST: async ({ request }) => {
